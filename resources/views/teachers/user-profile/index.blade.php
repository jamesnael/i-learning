        ...
        <div class="m-portlet m-portlet--full-height  ">
            <div class="m-portlet__body">
                <div class="m-card-profile">
                    ...
                    <form id="form-photo" role="form" action="{{ route('teacher-change-picture') }}" enctype="multipart/form-data">
                        <!-- Csrf Field -->
                        @csrf
                        <!-- Csrf Field -->
        ...
        <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="m_user_profile_tab_1">
                    <form class="m-form m-form--fit m-form--label-align-right" action="{{ route('teacher-change-information') }}" id="form-profile">
                        <!-- Csrf Field -->
                        @csrf
                        <!-- Csrf Field -->
                        <div class="m-portlet__body">
...
<!--                             <div class="form-group m-form__group row">
                ...
                <div class="tab-pane " id="m_user_profile_tab_2">
                    <!--begin::Form-->
                    <form class="m-form m-form--fit m-form--label-align-right m-form--state" id="form-reset-password" action="{{ route('teacher-change-password') }}">
                        <!-- Csrf Field  -->
                        @csrf
                        <!-- Csrf Field -->
                        <div class="m-portlet__body">
